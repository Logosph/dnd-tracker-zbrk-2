...
from app.utils.security import get_password_hash, create_access_token, verify_password, get_user_id_from_token
...
class UserService:
    ...
    async def signup(self, email: str, password: str, username: str | None = None) -> str:
    ...
    async def update_user(self, user_id: UUID, email: str | None = None, username: str | None = None, password: str | None = None) -> User:
